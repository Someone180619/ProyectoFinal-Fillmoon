...
<%
    ...
    List <Peliculas> peliculas = pps.LlamarFavoritos(id);
%>
    <%if(peliculas.size()>0){%>
    <div class="container-fluid mt-2 mb-1">
        <ul class="nav">
            ...
            <li class="nav-item mx-5 p-0">
                <form class="d-flex" action="categoria_favoritos.jsp">
                    <select name="seccion" class="form-select mx-1 bg-dark" id="SPF">
    ...
    <%}else{%>
        ...
        <ul class="nav">
            <li class="nav-item me-auto p-2 bd-highlight">
                <p class="fs-5 text-light" id="one">No ha agregado películas a su sección de favoritos...</p>
            </li>
        </ul> 
    </div>
    <%}%>
